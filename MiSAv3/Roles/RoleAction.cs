...
namespace MiSAv3.Roles
{
    internal class RoleAction
    {
        internal void createAdmin()
        {
            ...
            // Create a UserManager object based on the UserStore object and ApplicationDbContext
            ...
            UserStore<ApplicationUser>(context));
                        ...
                        IdUserResult = userMgr.Create(appUser, "iLabs@MiSA");
